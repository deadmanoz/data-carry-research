...
/// Spendability temporal distribution analyser
pub struct SpendabilityTemporalAnalyser;

impl SpendabilityTemporalAnalyser {
    ...
    pub fn analyse_temporal_distribution(db: &Database) -> AppResult<SpendabilityTemporalReport> {
