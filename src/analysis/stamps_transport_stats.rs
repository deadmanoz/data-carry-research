...
/// Analyser for Bitcoin Stamps transport statistics
pub struct StampsTransportAnalyser;

impl StampsTransportAnalyser {
    ...
    pub fn analyse_transport_breakdown(db: &Database) -> AppResult<StampsTransportAnalysis> {
        ...
        let pure_variant_list = Self::build_variant_list(&pure_variants, pure_tx_count);
        let cp_variant_list = Self::build_variant_list(&cp_variants, cp_tx_count);
...
pub struct TransportStats {
    ...
    #[serde(default)]
    pub variant_breakdown: Vec<VariantStats>,
...
/// Variant statistics within a transport mechanism
#[derive(Debug, Clone, Serialize, Deserialize)]
...
mod tests {
    ...
    fn test_analyser_with_empty_database() {
        ...
        let result = StampsTransportAnalyser::analyse_transport_breakdown(&db);
    ...
    fn test_variant_list_sorting() {
        ...
        let list = StampsTransportAnalyser::build_variant_list(&variants, 300);
