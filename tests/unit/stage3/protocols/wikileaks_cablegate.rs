...
use data_carry_research::types::{EnrichedTransaction, TransactionOutput};
...
mod test_data {
    ...
    pub fn create_transaction_with_p2ms_outputs(
        txid: &str,
        height: u32,
        num_outputs: usize,
    ) -> EnrichedTransaction {
...
/// Tests verifying output count alone does NOT trigger classification
mod bug_fix_verification {
    ...
    fn test_100_plus_outputs_without_address_not_classified() -> Result<()> {
        ...
        let tx = test_data::create_transaction_with_p2ms_outputs(txid, 230_000, 105);
    ...
    fn test_4_to_10_outputs_without_address_not_classified() -> Result<()> {
        ...
        let tx = test_data::create_transaction_with_p2ms_outputs(txid, 229_992, 6);
