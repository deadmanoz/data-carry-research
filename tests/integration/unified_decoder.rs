...
async fn test_decode_bitcoin_stamps_image_54fdeda9() -> anyhow::Result<()> {
    ...
    match result {
        ...
        Some(DecodedData::LikelyDataStorage(_)) => {
            panic!("❌ Unexpected LikelyDataStorage data");
        }
        None => {
...
async fn test_decode_omni_property_fixed_725ba7() -> anyhow::Result<()> {
    ...
    match result {
        ...
        Some(DecodedData::LikelyDataStorage(_)) => panic!("❌ Unexpected LikelyDataStorage data"),
